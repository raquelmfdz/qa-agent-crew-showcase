...
**GO.** Core login and checkout flows are fully covered and passing. The
single failure is an intentional, documented platform behavior used for
negative testing, not a functional regression.

---
*Generated by the qa-agent-crew Release Reporter agent (sample, not a live run).*
